describe('Register Test',() => {
    it ('Registration test',() => {
        cy.fixture('studentRegister').then(data => {
            ...
            cy.log('Ввод пароля')
            cy.get(':nth-child(3) > .form-control--medium > .form-input--password').type(data.num_password_register)
            cy.log('Ввод пароля')
            cy.get(':nth-child(4) > .form-control--medium > .form-input--password').type(data.num_password_repeat_register)
